...
export const Rules = () =>{
    ...
    return ( 
        ...
        <div className="RulesandPolices">
          <Banner></Banner>
          <Navbarr></Navbarr>
          <div id="title-bar"><h2>Rules and Policies</h2></div>
      ...
      <ol>
        ...
        <li>
          <span className="rule-introduction">TEAM BENCH AREAS</span>
          <ol type="a">
            <li>Recreation and District Programs
              <ul>
                <li>
      ...
      <h3 className="rules-header rule-introduction">EQUIPMENT</h3>
      <ul>
        <li>
      ...
      <h3 className="rules-header rule-introduction">NUMBER OF PLAYERS</h3>
      <ul>
        <li>
          <span className='rule-introduction'>TEAM SIZE.</span> Except as noted below, team rosters shall consist of not less
        ...
        <li>
          <span className='rule-introduction'>SIZE OF AGE GROUP TEAMS.</span> In order to give player's maximum
      ...
      <h3 className="rules-header rule-introduction">SUBSTITUTIONS</h3>
      <ul>
        <li>
      ...
      <h3 className="rules-header rule-introduction">CONFISCATED PLAYER PASSES</h3>
      <ul>
        <li>
      ...
      <h3 className="rules-header rule-introduction">ALL-PLAY</h3>
      <ul>
        <li>
      ...
      <h3 className="rules-header rule-introduction">PLAYER'S EQUIPMENT</h3>
      <ul>
        <li>
      ...
      <h3 className="rules-header rule-introduction">MIXED TEAMS</h3>
      <ul>
        <li><span className="rule-introduction">GIRLS PLAYING ON BOYS' TEAMS.</span> Girls are 
          eligible to play on boys' teams with parent/guardian permission.
        </li>
        <li><span className="rule-introduction">TYPES OF TEAMS.</span> Teams with females only 
          are Girls Teams. All others are Boys Teams.
        </li>
      </ul>
      <h3 className="rules-header rule-introduction">COACHING FROM THE SIDELINES</h3>
      <ul>
        <li>
      ...
      <h3 className="rules-header rule-introduction">GAME TERMINATION</h3>
      <ul>
        <li>
      ...
      <h3 className="rules-header rule-introduction">CONDITIONS OF REPLAY OF GAMES</h3>
      <ul>
        <li>
      ...
      <h3 className="rules-header rule-introduction">REFEREE RESPONSIBILITIES</h3>
      <ul>
        <li>
